(function(d){var e=function(a,b,c,f)
    {
    this.target=a;this.url=b;this.html=[];
    this.effectQueue=[];
...
e.prototype.load=function(a){
    ...
    e.prototype.render=function(){
        var a=this;this.load(function(b){
            ...
            }catch(c){return a.entries=[],a.feed=null,a.options.error.call(a)}b=a.generateHTMLForEntries();
